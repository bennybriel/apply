   ...
   <?php if($usr=="Student"): ?>                           
        <?php if($accpt==false): ?>   
         ...
         <?php elseif($accpt==true): ?>
              ...
              <?php endif; ?>
        <?php endif; ?>
        <?php if($accpt==true && $ismedical==true): ?>   
               <?php if($data): ?>   
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lautechp/apply.lautech.edu.ng/resources/views/paymentHome.blade.php ENDPATH**/ ?>