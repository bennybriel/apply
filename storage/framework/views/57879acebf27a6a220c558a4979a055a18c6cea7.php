...
-->
      ...
      <form class=""  id="" method="POST" action="<?php echo e(route('UpdatePassword')); ?>">
          ...
          <div class="card-group">
            <div class="card p-4">
              ...
              <div class="card-body">
                ...
                <p class="text-muted" style="color:#000000"><h3>Change User Password</h3></p>
                ...
                <div class="input-group mb-3">
                  ...
                  <input class="form-control" type="text" value="<?php echo e(session('email')); ?>" name="email" placeholder="Email/MatricNo" required readonly>
                </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <button class="btn px-4" type="submit" style="background:#c0a062">Change Password</button>
                  </div>
...
<?php echo $__env->make('layouts.applogReg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lautechp/apply.lautech.edu.ng/resources/views/changePassword.blade.php ENDPATH**/ ?>