...
<div class="card o-hidden border-0 shadow-lg my-5">
            ...
            <div class="card-body p-0">
                ...
                <form class=""  id="" enctype="multipart/form-data" method="POST" action="<?php echo e(route('AdmissionStatus')); ?>">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="text-center">
                                        <h1 class="h4 mb-4" style="color:#da251d">Check Admission Status</h1>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4  mb-4" style="color:#da251d">Check Admission</h1>
                                     ...
                                     <div class="form-group row">
                                       <div class="col-sm-8 mb-3 mb-sm-0">
                                        ...
                                        <button class="btn px-4" type="submit" style="background:#c0a062;color:white"> Check Status</button>
...
<?php echo $__env->make('layouts.appfront', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\admissions\resources\views/admissionStatus.blade.php ENDPATH**/ ?>