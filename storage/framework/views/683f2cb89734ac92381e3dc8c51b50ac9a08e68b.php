                                                                ...
                                                                <?php
                                                                    ...
                                                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo e($data->matricno); ?></td>
                                                                            <td><?php echo e($data->names); ?></td>
                                                                            <td><?php echo e($data->category1); ?></td>
                                                                           
                                                                             <td>
                                                                                <button type="button" class="btn btn-success" id="edit-item" data-item-id="<?php echo e($data->matricno); ?>" 
                                                                                  data-item-name="<?php echo e($data->names); ?>" data-item-total="<?php echo e($data->admissiontype); ?>" 
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="attachment-body-content">
        ...
        <form  class="form-horizontal" id="edit-form" method="POST" action="<?php echo e(route('UpdateRegisteredProgramme')); ?>">
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\admissions\resources\views/changeRegisteredProgramme.blade.php ENDPATH**/ ?>