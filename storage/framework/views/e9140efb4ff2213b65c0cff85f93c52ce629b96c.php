        ...
        <div class="col-md-8">
          ...
          <div class="card-group">
            <div class="card p-4">
              ...
              <div class="card-body">
                <h4 style="color:#da251d">Undergraduate Student Portal</h4>
                ...
                <div class="input-group mb-3">
                  ...
                  <input class="form-control" type="text" name="matricno" placeholder="Email/MatricNo" required>
                </div>
...
<?php echo $__env->make('layouts.applogReg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lautechp/apply.lautech.edu.ng/resources/views/auth/login.blade.php ENDPATH**/ ?>