              ...
              <div class="card-body">
                <h3 style="color:#da251d">Registration Confirmation</h3>
                  ...
                  <p style="color:#da251d"><em>Congratulations!!!, Your have successfully submitted Application.
                       ...
                       <a href="<?php echo e(route('screeningconf')); ?>" class="btn btn-primary" style="background:#c0a062;color:white">
...
<a href="<?php echo e(route('home')); ?>" class="btn btn-primary" style="background:#c0a062;border-color:#da251d;color=000000">
                                   Return Home
                                </a>                                
</div>
              </div>
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lautechp/apply.lautech.edu.ng/resources/views/registrationConfrimationPage.blade.php ENDPATH**/ ?>