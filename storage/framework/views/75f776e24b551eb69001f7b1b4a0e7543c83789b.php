            ...
            <div class="card p-4">
              <div class="card-body">
                <h3 style="color:#da251d">Signup Verification</h3>
                  ...
                  <p style="color:#000000"><em><?php echo e($rec); ?></em></p>
                  <?php if($m==1): ?>
                  <div class="col-6">
                       <button class="btn px-4" type="button" style="background:#c0a062"><a href="<?php echo e(route('logon')); ?>">Login</a></button>
                  </div>
...
<?php echo $__env->make('layouts.applogReg2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lautechp/apply.lautech.edu.ng/resources/views/accountActivated.blade.php ENDPATH**/ ?>