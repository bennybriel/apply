...
-->
      ...
      <form class=""  id="" method="POST" action="<?php echo e(route('UpdateStudentPassword')); ?>">
        ...
        <div class="col-md-10">
          ...
          <div class="card-group">
            <div class="card p-4">
              ...
              <div class="card-body">
                <h4 style="color:#da251d">Change Password</h4>
                ...
                <div class="row">
                  <div class="col-6">
                    <button class="btn px-4" type="submit" style="background:#c0a062;color:#FFFFFF">Change Password</button>
                  </div>
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lautechp/apply.lautech.edu.ng/resources/views/changeMyPassword.blade.php ENDPATH**/ ?>