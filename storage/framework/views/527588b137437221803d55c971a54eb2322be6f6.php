 ...
 if($apptype=="PDS")
  {
    ...
    $p3 = DB::SELECT('CALL FetchApplicationListingByID(?)',array($med));
    #Tuition
    $cat = DB::SELECT("CALL GetStudentStateIdentity(?)",array($matricno));
   //dd($p1);
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\admissions\resources\views/paymentHome.blade.php ENDPATH**/ ?>