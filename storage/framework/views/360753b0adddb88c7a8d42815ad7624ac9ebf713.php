                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                                ...
                                                                <?php
                                                                    $i=0;
                                                                    ?>
                                                                    <?php $__currentLoopData = $tk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td><?php echo e(++$i); ?></td>
                                                                            <td><?php echo e($tk->ticketid); ?> </td>
                                                                            <td><?php echo e($tk->subject); ?>  </td>  
                                                                            <td> <?php echo e($tk->complain); ?> </td>
                                                                            <td> <?php echo e($tk->response); ?> </td>
                                                                            <td> <?php echo e($tk->created_at); ?> </td>
                                                                              <td>
                                                                                 <?php if($tk->isclosed =='1'): ?>
...
<div class="row">
   ...
   <?php if($usr=="Candidate"): ?>                           
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1" style="color:red"><strong><?php if($p3): ?> <?php echo e($p3[0]->name); ?> <?php endif; ?></strong></div>
                                    <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col">
                                         <?php if($p3  && $p3[0]->status == true): ?>
                                          <div class="col-auto">
                                            ...
                                            <!--  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">10%</div> -->
                                                <a href="<?php echo e(route('PayNow',['id'=>$p_3,'prod'=>$p3[0]->name])); ?>"
               ...
               <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" style="color:red"><strong><?php if($p9): ?> <?php echo e($p9[0]->name); ?> <?php endif; ?></strong></div>
                                <div class="row no-gutters align-items-center">
        ...
        <?php if($usr=="Candidate" && (Auth::user()->apptype=="UGD" || Auth::user()->apptype=="PD")): ?>   
           <!----Change of Programme 
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                                ...
                                                                <?php
                                                                    $i=0;
                                                                    ?>
                                                                    <?php $__currentLoopData = $dats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td><?php echo e(++$i); ?></td>
                                                                            <td><?php echo e($dats->name); ?> </td>
                                                                            <td><?php echo e($dats->cutoff); ?>  </td>  
                                                                            <td> <?php echo e($dats->requirement); ?> </td>
                                                                            <td> <?php echo e($dats->utmerequirement); ?> </td>
                                                                         </tr>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </tbody>
                                                            </table>
                                               ...
                                               <!----Change of Programme  --->
                                                 <?php if($chnge==1): ?>
                                                     <!---  <a href="<?php echo e(route('changeProgramme')); ?>"  class="btn btn-info btn-icon-split">
                                                         <span class="icon text-white-50">
                                                           <i class="fas fa-arrow-right"></i>
                                                          </span>
                                                   ...
                                                   <div class="col-xl-3 col-md-6 mb-4">
                                                       <div class="card border-left-primary shadow h-100 py-2">
                                                        <div class="card-body">
                                                            <div class="row no-gutters align-items-center">
                                                                <div class="col mr-2">
                                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><strong><?php if($p8): ?> <?php echo e($p8[0]->name); ?> <?php endif; ?></strong></div>
                                                                    <div class="row no-gutters align-items-center">
                                                                        <div class="col">
                                                                         <?php if($p8  && $p8[0]->status == true): ?>
                                                                          <div class="col-auto">
                                                                            <h7>&#8358;<?php echo e(number_format($p8[0]->amount,2)); ?> </h7>
                                                                            <!--  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">10%</div> -->
                                                                                <a href="<?php echo e(route('PayNow',['id'=>$p_8,'prod'=>$p8[0]->name])); ?>"
                                                                                                            class="btn btn-primary btn-icon-split">
                                                                                <span class="icon text-white-50">
                                                                                        <i class="fas fa-arrow-right"></i>
                                                                                </span>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Referee Status</div>
                                            <div class="h5 mb-0 font-weight-bold text-danger-800"><?php echo e($re); ?> out of 3 </div>
                                             <?php if($re==3): ?>
                                        ...
                                        <div class="col-auto">
                                                 <a href="" data-toggle="modal"  data-target-id="<?php echo e($matricno); ?>"  data-target="#myModalview"  class="btn btn-primary" > View</a>
                            ...
                            <thead>
                                ...
                                <tr>
                                   <td class="noBorder">Programme </td>
                                    ...
                                    <td class="noBorder1"><?php echo e(GetPGProgramme($dat[0]->category1)); ?></td>
                                </tr>
                                <?php else: ?>
                                <td class="noBorder">Programme </td>
                                ...
                                <tr>
                                  <?php if($apptype=="UGD" && Auth::user()->isChange=='1'): ?>
                                       <?php
                                          $ch = DB::table('change_programmes')->where('utme',Auth::user()->utme)->first();
                                        ?>
                                         <tr style="color:red">
                                            <td class="noBorder"><b>New Programme</b> </td>
                                            <td class="noBorder1"><?php if($ch): ?> <b><?php echo e($ch->programme); ?></b> <?php endif; ?></td>
                                        </tr>
                                     <?php endif; ?>
                                <?php endif; ?>
                                <tr>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                                ...
                                                                <?php
                                                                    $i=0;
                                                                    ?>
                                                                    <?php $__currentLoopData = $ole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ole): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td><?php echo e(++$i); ?></td>
                                                                            <td><?php echo e($ole->subject); ?></td>
                                                                            <td><?php echo e($ole->grade); ?></td>
                                                                            <td><?php echo e($ole->examnumber); ?></td>
                    ...
                    <div class="col mr-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <?php if($apptype =="UGD" || $apptype =="DE" || $apptype =="TRF"): ?>
                                ...
                                <?php elseif($apptype =="PDS" || $apptype =="JUP" || $apptype =="PT"): ?>
...
<?php if(Auth::user()->isadmitted == true ): ?>
    ...
    <?php endif; ?>
     ...
     <?php endif; ?>
       ...
       <?php endif; ?>
        <?php if(Auth::user()->isict==false && $apptype =="PDS"): ?>
           <a href="<?php echo e(route('paymentHome')); ?>" class="btn btn-success btn-icon-split">
                                                        <span class="icon text-white-50">
                                                            <i class="fas fa-arrow-right"></i>
                                                        </span>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                               ...
                               PartTime Total Paid Applicant</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                 <?php echo e(number_format($apl[0]->pt,0)); ?>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php echo e(number_format($reg[0]->pt,0)); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php echo e(number_format($apl[0]->pg,0)); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php echo e(number_format($reg[0]->pg,0)); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php echo e(number_format($rec->data[0]->counter,0)); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php echo e(number_format($res->data[0]->counter,0)); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo e(route('CheckUTME')); ?>">
                    ...
                    <input type="hidden" name="id"  value="<?php echo e($p_7); ?>" class="form-control">
                    <input type="hidden" name="prod" value="<?php echo e($p7[0]->name); ?>" class="form-control">
...
<div class="modal fade" id="pdsjupebModal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo e(route('ValidatePDSJUPEB')); ?>">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo e(route('PGApplication')); ?>">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <input type="hidden" name="id"  value="<?php echo e($p_6); ?>" class="form-control">
                    <input type="hidden" name="prod" value="<?php echo e($p6[0]->name); ?>" class="form-control">
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\admissions\resources\views/home.blade.php ENDPATH**/ ?>