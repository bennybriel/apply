...
<div class="card o-hidden border-0 shadow-lg my-5">
            ...
            <div class="card-body p-0">
                ...
                <form class=""  id="" enctype="multipart/form-data" method="POST" action="<?php echo e(route('PdsJupebs')); ?>">
                                    ...
                                    <?php if(Session::has('error')): ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <?php if($data): ?>
                                                    <input type="text" name="surname" value="<?php echo e($sname); ?>" class="form-control form-control" id="exampleLastName"
                                            ...
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <?php if($data): ?>
                                                    <input type="text" name="firstname" locked="false" value="<?php echo e($fname); ?>" class="form-control form-control" id="exampleFirstName"
                                        ...
                                        <div class="form-group row">
                                             <div class="col-sm-6 mb-3 mb-sm-0">
                                                <?php if($data): ?>
                                                    <input type="text" name="othername" locked="false" value="<?php echo e($oname); ?>" class="form-control form-control" id="exampleFirstName"
                                              ...
                                              <div class="col-sm-6 mb-3 mb-sm-0">
                                                <?php if($dat): ?>
                                                    <input type="hidden" value="<?php echo e($dat[0]->matricno); ?>" name="utme" class="form-control form-control"
                                        ...
                                        <div class="form-group">
                                            <?php if($data): ?>
                                                <input type="email" name="email" value="<?php echo e($dat[0]->email); ?>" class="form-control form-control" id="exampleInputEmail"
                                          ...
                                          <div class="form-group row">
                                             ...
                                             <?php if($p): ?>  
                                               ...
                                               <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <select name="category1" id="category1" class="form-control form-control" readonly>
                                                    <option value="<?php echo e($p[0]->programme); ?>"><?php echo e($p[0]->programme); ?></option>
                                              ...
                                              <div class="form-group row">
                                                    ...
                                                    <?php if($dat): ?>
                                                      <select name="session" id="session" class="form-control form-control" readonly>
                                                       <option value="<?php echo e($dat[0]->activesession); ?>"><?php echo e($dat[0]->activesession); ?></option>
                                                    <?php else: ?>
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\admissions\resources\views/pdsjupebDataPage.blade.php ENDPATH**/ ?>