...
<?php if($pro): ?>
  <b><?php echo e(strtoupper($pro[0]->name)); ?> (<?php echo e(strtoupper(Auth::user()->utme)); ?>)</b>
<?php endif; ?>
<br/>
 <b>Dear <?php echo e(strtoupper(Auth::user()->firstname)); ?> </b>,
<br/>
...
<p style="text-align:justify; ">I am delighted to notify you that you have been offered provisional admission to
 LADOKE AKINTOLA UNIVERSITY OF TECHNOLOGY, OGBOMOSO to study  <strong><?php if($pro): ?> <?php echo e($pro[0]->programme); ?> <?php endif; ?> </strong> in the 
 Faculty of  <strong> <?php if($pro): ?> <?php echo e(GetFaculty($pro[0]->programme)); ?> <?php endif; ?> </strong> at undergraduate level. Consequently, 
...
<?php /**PATH D:\xampp\htdocs\admissions\resources\views/admissionLetterUGD.blade.php ENDPATH**/ ?>