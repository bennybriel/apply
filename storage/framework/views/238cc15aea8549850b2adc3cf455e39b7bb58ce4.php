...
<div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <form class=""  id="" enctype="multipart/form-data" method="POST" action="<?php echo e(route('GetTransactions')); ?>">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="text-center">
                                        <h1 class="h4 mb-4" style="color:#da251d">Get Transaction</h1>
                                    </div>
                                    ...
                                    <div class="text-center">
                                     ...
                                     <div class="form-group row">
                                       <div class="col-sm-8 mb-3 mb-sm-0">
                                            <input type="text" name="matricno" class="form-control form-control" id="exampleInputEmail"
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\admissions\resources\views/getTransaction.blade.php ENDPATH**/ ?>