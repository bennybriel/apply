...
<div class="card o-hidden border-0 shadow-lg my-5">
            ...
            <div class="card-body p-0">
                ...
                <form class=""  id="" enctype="multipart/form-data" method="POST" action="<?php echo e(route('UTMEDatas')); ?>">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="text-center">
                                        <h1 class="h4 mb-4" style="color:#da251d"> Post UTME Biodata [<?php echo e($ulist[0]->utme); ?>]</h1>
                                         ...
                                         <?php endif; ?>
                                          ...
                                          <div class="form-group row">
                                            <?php if($sp): ?>
                                                 ...
                                                 <?php if($ulist[0]->totalscore >= $sp[0]->score): ?>
                                                 ...
                                                 <?php else: ?>
                                                    ...
                                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <?php if($category1): ?>
                                                              ...
                                                              <?php $__currentLoopData = $cl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <hr/>
                                          <div class="text-center">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <?php if($ulist): ?>
                                                        <input type="text" value="<?php echo e($ulist[0]->score4); ?>" name="emglish" class="form-control form-control" id="exampleLastName"
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                <?php if($ulist): ?>
                                                    <input type="text" value="<?php echo e($ulist[0]->subject1); ?>" name="subject1" class="form-control form-control" readonly>
                                                <?php endif; ?>       
                                                </div>
                                                <div class="col-sm-6">
                                                    <?php if($ulist): ?>
                                                        <input type="text" value="<?php echo e($ulist[0]->score1); ?>" name="score1" class="form-control form-control" id="exampleLastName"
                                                        placeholder="SurName" required readonly>
                                                    <?php else: ?>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                <?php if($ulist): ?>
                                                    <input type="text" value="<?php echo e($ulist[0]->subject2); ?>" class="form-control form-control" name="subject2" readonly>
                                                <?php endif; ?>       
                                                </div>
                                                <div class="col-sm-6">
                                                    <?php if($ulist): ?>
                                                        <input type="text" value="<?php echo e($ulist[0]->score2); ?>" name="score2" class="form-control form-control" id="exampleLastName"
                                                        placeholder="SurName" required readonly>
                                                    <?php else: ?>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                <?php if($ulist): ?>
                                                    <input type="text" value="<?php echo e($ulist[0]->subject3); ?>" class="form-control form-control" name="subject3" readonly>
                                                <?php endif; ?>       
                                                </div>
                                                <div class="col-sm-6">
                                                    <?php if($ulist): ?>
                                                        <input type="text" value="<?php echo e($ulist[0]->score3); ?>" name="score3" class="form-control form-control" id="exampleLastName"
                                                        placeholder="SurName" required readonly>
                                                    <?php else: ?>
                                            ...
                                            <label><strong style="color:red">Total Score: <?php if($ulist): ?> <?php echo e($ulist[0]->totalscore); ?> <?php endif; ?> </strong></label>
                                        <hr/>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                                ...
                                                                <?php
                                                                    $i=0;
                                                                    ?>
                                                                    <?php $__currentLoopData = $usb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td><?php echo e(++$i); ?></td>
                                                                            <td><?php echo e($data->utme); ?></td>
                                                                            <td><?php echo e($data->subject); ?></td>
                                                                            <td><?php echo e($data->grade); ?></td>
                                                                            <td><?php echo e($data->examtype); ?></td>
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lautechp/apply.lautech.edu.ng/resources/views/utmeDataPage.blade.php ENDPATH**/ ?>