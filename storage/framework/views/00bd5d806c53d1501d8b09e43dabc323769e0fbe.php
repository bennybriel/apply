...
<body id="page-top">
    ...
    <div id="wrapper">
                       ...
                       <li class="nav-item">
                        ...
                        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="<?php echo e(route('home')); ?>">Home</a>
                                 <?php if($apptype=="UGD" || $apptype=="DE"  || $apptype=="TRF"): ?>
                                         <a class="collapse-item" href="<?php echo e(route('validateUTME')); ?>">Validate UTME</a>
                                            ...
                                            <?php endif; ?>
                                            <?php if(Auth::user()->isChange=='1' && $apptype=="UGD"): ?>
                                                        <a class="collapse-item" href="<?php echo e(route('changeProgramme')); ?>">Change Programme</a>
                                            <?php endif; ?>
                                  ...
                                  <?php endif; ?>
                                    <?php if($apptype=="PDS"): ?>
                                       <?php if($isadm==true): ?>
                                              ...
                                              <a class="collapse-item" href="<?php echo e(route('admissionLetterPDS')); ?>">Admission Letter</a>
                                              <a class="collapse-item" href="<?php echo e(route('stateIdentity')); ?>">State Identification</a>
                                       <?php endif; ?>
                                    <?php endif; ?>
                                        <?php if($iscomplete==true): ?>
                                ...
                                <?php endif; ?>        
                            <?php endif; ?> 
                              <?php if($apptype=="UGD" && $admitted): ?>
                                       <?php if($isadm==true): ?>
                                             <a class="collapse-item" href="<?php echo e(route('admissionLetterUGD')); ?>">Admission Letter</a>
                                             <a class="collapse-item" href="<?php echo e(route('stateIdentity')); ?>">State Identification</a>
                                       <?php endif; ?>
                                    <?php endif; ?>
                             <?php if($apptype=="UGD" || $apptype=="PD"): ?>
                               <?php if($pres && $ol): ?>  
                                  <a class="collapse-item" href="<?php echo e(route('postUTMEResult')); ?>">Check Post-UTME Result</a> 
                               <?php endif; ?>
                             <?php endif; ?>
                        ...
                        <!-- Nav Item - Pages Collapse Menu -->
                            ...
                            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    <h6 class="collapse-header">Access Screens:</h6>
                                    <a class="collapse-item" href="<?php echo e(route('home')); ?>">Home</a>
                                    <?php if(trim($apptype)=="PT" && $isadm=='1'): ?>
                                       <a class="collapse-item" href="<?php echo e(route('admissionLetterPT')); ?>">Admission Letter</a>
                                    <?php endif; ?>
                                    <?php if($apptype=="JUP" && $isadm==true): ?>
                                        <a class="collapse-item" href="<?php echo e(route('admissionLetter')); ?>">Admission Letter</a>
                                        <a class="collapse-item" href="<?php echo e(route('stateIdentity')); ?>">State Identification</a>
                                       
                                         
                                     <?php endif; ?>
                                      <?php if($apptype=="PG" && $isadm=='1'): ?>
                                        <a class="collapse-item" href="<?php echo e(route('admissionLetterPG')); ?>">Admission Letter</a>
                                        <a class="collapse-item" href="<?php echo e(route('pgAcceptanceForm')); ?>">Acceptance Form</a>
                                      <?php endif; ?>
                                      ...
                                      <?php if($apptype=="PDS"): ?>
                                         <?php if($isadm==true): ?>
                                          ...
                                          <?php endif; ?>
                                       <?php endif; ?>
                                    <?php if($iscomplete=='1' && $apptype=="UGD"): ?>
                                        <a class="collapse-item" href="<?php echo e(route('UTMEPrintScreening')); ?>">Registration Confirmation</a>
                                    <?php endif; ?>
                                   <?php if($apptype=="UGD" || $apptype=="PD"): ?>
        ...
        <?php endif; ?>
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php if($rol && $rol[0]->section=="Predegree"): ?>
                                 <?php if($rol[0]->roleid == 2): ?><!--Admin  -->
                                        ...
                                        <a class="collapse-item" href="<?php echo e(route('uploadpdsResult')); ?>">Upload JUPEB Results</a>
                                        <a class="collapse-item" href="<?php echo e(route('lgaList')); ?>">Update LGA</a>
                                      
                                        <div class="collapse-divider"></div>
                                        <h6 class="collapse-header">Reports:</h6>
                                         <a class="collapse-item" href="<?php echo e(route('jupebPaymentReport')); ?>">Download JUPEB Payment </a>
                                         <a class="collapse-item" href="<?php echo e(route('downloadPDSPayment')); ?>">Download PDS Payment </a>
                                         <a class="collapse-item" href="<?php echo e(route('pdsPaymentList')); ?>">PDS Payment </a>
                     ...
                     <?php elseif($rol && $rol[0]->section=="PartTime"): ?>
                                 <?php if($rol[0]->roleid == 2): ?><!--Admin  -->
                                        <a class="collapse-item" href="<?php echo e(route('createusers')); ?>">Create User</a>
                                        <a class="collapse-item" href="<?php echo e(route('ptRegisteredList')); ?>">Download PT List </a>
                     ...
                     <?php elseif($rol && $rol[0]->section=="PostGraduate"): ?>
                                 <?php if($rol[0]->roleid == 2): ?><!--Admin  -->
                                        <a class="collapse-item" href="<?php echo e(route('createusers')); ?>">Create User</a>
                                        <a class="collapse-item" href="<?php echo e(route('pgApplicantList')); ?>">Download PG Application List </a>
                                        <a class="collapse-item" href="<?php echo e(route('uploadPGAdmission')); ?>">Upload PG Admission</a>
                                        <div class="collapse-divider"></div>
                                        <h6 class="collapse-header">Reports:</h6>
                                ...
                                <?php elseif($rol[0]->roleid == 3): ?>
                                     <a class="collapse-item" href="<?php echo e(route('pgApplicantList')); ?>">Download PG List </a>
                                     <a class="collapse-item" href="<?php echo e(route('uploadPGAdmission')); ?>">Upload PG Admission</a>
                                <?php endif; ?>           
                                
                     <?php elseif($rol && $rol[0]->section=="Support"): ?>
                       
                       
                        <a class="collapse-item" href="<?php echo e(route('ticketList')); ?>">Support Ticket</a>
                        <a class="collapse-item" href="<?php echo e(route('getTransaction')); ?>">Transactions</a>
                        <a class="collapse-item" href="<?php echo e(route('sendEmail')); ?>">Send Email</a>
                        <!--Addmission Section -->
                     
                      <?php elseif($rol && $rol[0]->section=="Bursary"): ?>
                            <a class="collapse-item" href="<?php echo e(route('paymentReport')); ?>">Payment Report</a>
                     ...
                     <?php elseif($rol && $rol[0]->section=="Admission"): ?>
                            ...
                            <?php if($rol[0]->roleid == 2): ?><!--Admin  -->
                                  ...
                                  <a class="collapse-item" href="<?php echo e(route('documentScreening')); ?>">Document Screening</a>
                                  <a class="collapse-item" href="<?php echo e(route('documentScreeningList')); ?>">Document Screening List</a>
                                  <a class="collapse-item" href="<?php echo e(route('paymentReport')); ?>">Payment Report</a>
                                <div class="collapse-divider"></div>
                                <h6 class="collapse-header">Reports:</h6>
                                   ...
                                   <?php if(Auth::user()->email="osolaosebikan@lautech.edu.ng"): ?>
                                       <a class="collapse-item" href="<?php echo e(route('downloadPostUTME')); ?>">Check Post UTME</a>
                                   <?php endif; ?>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Access Screens:</h6>
                         <a class="collapse-item" href="<?php echo e(route('home')); ?>">Home</a>
                          <a class="collapse-item" href="<?php echo e(route('studentInfo')); ?>">Update StudentInfo</a>
                         <a class="collapse-item" href="<?php echo e(route('downloadPostUTME')); ?>">Check Post UTME</a>
                         <a class="collapse-item" href="<?php echo e(route('activeUsers')); ?>">Active Users</a>
                         <a class="collapse-item" href="<?php echo e(route('sendEmail')); ?>">Send Email</a>
                         <a class="collapse-item" href="<?php echo e(route('cancelTransaction')); ?>">Cancel Transaction</a>
                         <a class="collapse-item" href="<?php echo e(route('removeChangedProgramme')); ?>">Remove Programme</a>
                         <a class="collapse-item" href="<?php echo e(route('lockAccess')); ?>">Lock User</a>
                         <a class="collapse-item" href="<?php echo e(route('paymentBiodata')); ?>">Biodata Payment</a>
                         <a class="collapse-item" href="<?php echo e(route('ticketList')); ?>">Ticket</a>
                         <a class="collapse-item" href="<?php echo e(route('getTransaction')); ?>">Transactions</a>
                         <a class="collapse-item" href="<?php echo e(route('createusers')); ?>">Create User</a>
                         <a class="collapse-item" href="<?php echo e(route('setCutoff')); ?>">Set Cutoff</a>
                         <a class="collapse-item" href="<?php echo e(route('documentScreening')); ?>">Document Screening</a>
                         <a class="collapse-item" href="<?php echo e(route('documentScreeningList')); ?>">Document Screening List</a>
                         <a class="collapse-item" href="<?php echo e(route('lgaList')); ?>">Update JUP/PDS LGA</a>
                        ...
                        <h6 class="collapse-header">Uploads:</h6>
                         <a class="collapse-item" href="<?php echo e(route('uploadPTAdmission')); ?>">Upload PT Admission</a>
                         <a class="collapse-item" href="<?php echo e(route('uploadPGAdmission')); ?>">Upload PG Admission</a>
                        <a class="collapse-item" href="<?php echo e(route('uploadBiodataUpdates')); ?>">Upload Biodata</a>
                        <a class="collapse-item" href="<?php echo e(route('uploadAdmission')); ?>">Upload UGD List</a>
                        <a class="collapse-item" href="<?php echo e(route('uploadPDScreeningScore')); ?>">Upload PDS Results</a>
            ...
            <?php endif; ?>
             <?php if($ispd==0  && $usr=='Candidate' ): ?>
              
                 <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('payhistory')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Payment History</span></a>
            </li>
             <?php endif; ?>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('supportPage')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Support</span></a>
            </li>
            <hr class="sidebar-divider d-none d-md-block">
...
</html><?php /**PATH D:\xampp\htdocs\admissions\resources\views/layouts/appdashboard.blade.php ENDPATH**/ ?>