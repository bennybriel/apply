...
<h5 align="center" style="color:#da251d"><b><?php echo e($des); ?>  Receipt <?php echo e(Auth::user()->activesession); ?> </b> </h5>
  <?php if($data): ?>
              ...
              <thead>
                <tr>
                  <td width="91" rowspan="9" class="noBorder" >                  </td>
                   ...
                   <td width="371" class="noBorder1"><?php echo e(Auth::user()->name); ?></td>
                ...
                <?php endif; ?>
                  ...
                  <tr>
                    ...
                    <td class="noBorder1"><?php echo e($dept); ?></td>
                  </tr>

                 <?php if($cpro): ?>
                     <tr style="color:red">
                        <td class="noBorder">New Department </td>
                       <td class="noBorder1"><?php echo e($cpro); ?></td>
                    </tr>
                 <?php endif; ?>
                 <tr>
                     <td  class="noBorder">State of Origin </td>
                     <td class="noBorder1"><?php echo e(GetState($mat)); ?></td>
                  </tr> 
                  
                 <tr>
                  <td  class="noBorder">Paid Sum of </td>
                   <td class="noBorder1">N<?php echo e(number_format(($amount),2)); ?></td>
                </tr> 
                
                <tr>
                  <td  class="noBorder">TransactionID </td>
                   <td class="noBorder1"><?php echo e($tra); ?></td>
                </tr> 
                <tr>
                  <td  class="noBorder">Amount In Words</td>
                   <td class="noBorder1"><?php echo e(numberTowords($amount)); ?></td>
                </tr> 
               

                <tr>
                  <td  class="noBorder">Date of Payment </td>
                   <td class="noBorder1"><?php echo e($dat); ?></td>
                </tr>              
                
                <tr>
                  <td  class="noBorder">Being Paid For </td>
                   <td class="noBorder1"><?php echo e(strtoupper($des)); ?></td>
                </tr>         
                </thead>
         </table>
 </div>
                  ...
                  <tr>
                    <td width="373" class="noBorder1">
                       <?php 
                        ...
                        //$promise = Http::async()->get('https://example.test');
                       // $promise->getState(); // Probably 'pending'
                        //sleep(6);
                        //$promise->getState(); // Probably 'fulfilled'
                       
                           if(Auth::user()->apptype=='UGD')
                            {
                              $promise = Http::async()->get('http://api.qrserver.com/v1/create-qr-code/?data="'.$qr2.'&size=100x100');     //; //config('paymentUrl.product_id_url_all');     
                            }
                            else
                            {
                              $promise= Http::async()->get('http://api.qrserver.com/v1/create-qr-code/?data="'.$qr1.'&size=100x100');           //config('paymentUrl.product_id_url_all');     
                            } 
...
?>
<?php /**PATH D:\xampp\htdocs\admissions\resources\views/getReceipt.blade.php ENDPATH**/ ?>