      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="card-group">
            <div class="card p-4">
              <div class="card-body">
                <h3 style="color:#da251d">Reference Confirmation</h3>
                  <p class="text-muted" style="color:#000000"></p>
                  <p style="color:#da251d"><em>Thank You Sir/Ma!, The Reference has been successfully submitted. 
                   </em></p>
...
<?php echo $__env->make('layouts.applogReg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lautechp/apply.lautech.edu.ng/resources/views/pgreferenceResponse.blade.php ENDPATH**/ ?>