                                        ...
                                        <?php if($result): ?>  
                                          ...
                                          <div class="col-sm-12 mb-3 mb-sm-0">
                                             <select name="department" id="department" class="form-control form-control" required>
                                               <option value="<?php echo e($result[0]->department); ?>"><?php echo e(GetPGDepartment($result[0]->category1)); ?></option>
                                          ...
                                          <?php else: ?>
                                           <div class="col-sm-12 mb-3 mb-sm-0">
                                             <select name="department" id="department" class="form-control form-control" required>
                                             <?php if($department): ?>
                                                   <option value="<?php echo e($department); ?>"><?php echo e(GetPGDepartment($category1)); ?></option>
                                                   <?php $__currentLoopData = $dep; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                     <option value="<?php echo e($dep->departmentid); ?>"><?php echo e($dep->department); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                             ...
                                             <?php if($result): ?>  
                                               ...
                                               <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <select name="category1" id="category1" class="form-control form-control" required>
                                                    <option value="<?php echo e($result[0]->category1); ?>"><?php echo e(GetPGProgramme($result[0]->category1)); ?></option>
                                                    <option value=""> </option>
                                               ...
                                               <?php else: ?>
                                                <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <select name="category1" id="category1" class="form-control form-control" required>
                                                  <?php if($category1): ?>
                                                        <option value="<?php echo e($category1); ?>"><?php echo e(GetPGProgramme($category1)); ?></option>
                                                        <option value=""></option>
                                                     <?php else: ?>
...
?>
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\admissions\resources\views/pgdataPage.blade.php ENDPATH**/ ?>