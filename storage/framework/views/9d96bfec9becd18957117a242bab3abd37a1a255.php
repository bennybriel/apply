...
<?php
  ...
  $p_1 =1;$p_2 =6; $p_3=8;$p_4=14; $p_5=12;$p_6=9; 
  $p3=0;$p4=0;$p5=0;$p6=0;
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <?php if($p6 && $p6[0]->status == true): ?>    
                                            ...
                                            <h7> </h7>
                                            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#pgModal"  style="background:#c0a062;color:white">Pay Now </button>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1" style="color:red"><strong>2020/2021 PDS/JUPEB </strong></div>
                                    <div class="row no-gutters align-items-center">
            ...
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                            Part-Time Total Paid Applicant</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
            ...
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                              Part-Time Total Registered</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo e(route('ValidatePDSJUPEB')); ?>">
                    ...
                    <br/>
                    <input type="text" name="formnumber" class="form-control" placeholder="Enter Formnumber" required>
                    <br/>
...
<?php echo $__env->make('layouts.appdashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\admissions\resources\views/home.blade.php ENDPATH**/ ?>