                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                                ...
                                                                <?php
                                                                    $i=0;
                                                                    ?>
                                                                    <?php $__currentLoopData = $pqua; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pqua): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td><?php echo e(++$i); ?></td>
                                                                            <td><?php echo e($pqua->degree); ?></td>
                                                                            <td><?php echo e($pqua->year); ?></td>
                                                                            <td><?php echo e($pqua->award); ?></td>
                                                                            <td><?php echo e($pqua->classofdegree); ?></td>
...
<?php 
  ...
  } ?><?php /**PATH D:\xampp\htdocs\admissions\resources\views/printPGData.blade.php ENDPATH**/ ?>