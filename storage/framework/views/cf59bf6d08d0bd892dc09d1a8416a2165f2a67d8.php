...
<br/>
   <?php if($pro): ?>
     <b style="font-size:20px;">Dear <?php echo e(strtoupper($pro->name)); ?> (<?php echo e(strtoupper(Auth::user()->formnumber)); ?>)</b>
   <?php endif; ?> 
<br/>
<div class="headingCenter" style="font-size:22px;">  <?php echo e(Auth::user()->activesession); ?> Academic Session</div>
...
that you have been offered provisional admission to pursue <?php echo e($level); ?> years Bsc Degree Programme in the department of <strong><?php if($pro): ?> <?php echo e($pro->programme); ?> <?php endif; ?> </strong> in the 
  </strong>
 </p>
...
<?php /**PATH D:\xampp\htdocs\admissions\resources\views/admissionLetterPT.blade.php ENDPATH**/ ?>