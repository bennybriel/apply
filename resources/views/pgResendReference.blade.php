...
<div class="card o-hidden border-0 shadow-lg my-5">
            ...
            <div class="card-body p-0">
                ...
                <form class=""  id="" enctype="multipart/form-data" method="POST" action="{{ route('ResendRefEmails') }}">
                                        {{ csrf_field() }}
                                                                ...
                                                                <?php
                                                                    ...
                                                                    @foreach($data as $data)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $data->email }}</td>
                                                                            <td>
                                                                                <a href="{{ route('DeleteResendReferenceInfo', $data->id) }}" class="btn btn-danger">Delete</a>
                                                                                <a href="{{ route('ResendReference',['id'=>$data->email,'uid'=>$data->guid]) }}" class="btn btn-success">Resend Email</a>
                                                                            </td>
