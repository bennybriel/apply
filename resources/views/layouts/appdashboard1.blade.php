                 ...
                 <hr class="sidebar-divider my-0">
                        ...
                        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="{{  route('home') }}">Home</a>
                           <!--Addmission Section -->
                           @if($rol && $rol[0]->section=="Admission")
                                 @if($rol[0]->roleid == 2)<!--Admin  -->
                                        ...
                                        <div class="collapse-divider"></div>
                                        <h6 class="collapse-header">Reports:</h6>
                                        <a class="collapse-item" href="{{ route('viewCandidateInfo') }}">View Addmission</a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                          ...
                          @if(Auth::user()->photo)
                             <img class="nav-user-photo" src="{{ asset('..//Passports/Students/'.Auth::user()->photo)}}" alt="Member's Photo" width="80px" height="70px" />
                        @else
