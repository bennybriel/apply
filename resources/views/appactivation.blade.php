                                                                                ...
                                                                                <div class="modal-dialog">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <h4 class="modal-title">Update {{ $data->appname }}</h4>
                                                                                            <form class="form-group" action="/UpdateAppActivation/{{ $data->id}}" method="post" id="editCommunityForm_{{$data->id}}">
                                                                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                                                                <input type="date" name="closedate" class="form-control" value="{{ $data->closedate }}">
                                                                                            </form>
                                                                                            <button class="btn btn-custom" style="background:#c0a062;color:white" type="submit" form="editCommunityForm_{{$data->id}}">Update</button><br /><br />
