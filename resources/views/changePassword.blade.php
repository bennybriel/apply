...
-->
      ...
      <form class=""  id="" method="POST" action="{{ route('UpdatePassword') }}">
                                                    {{ csrf_field() }}
            ...
            <div class="card p-4">
              ...
              <div class="card-body">
                ...
                <div class="input-group mb-3">
                  ...
                  <input class="form-control" type="text" value="{{ $guid }}" name="guid" placeholder="Email/MatricNo" required readonly>
                </div>
