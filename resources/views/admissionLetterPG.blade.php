                 ...
                 <tr>
                    <td width="150" class="noBorder1">
                       @if($pro)
                        ...
                        <br/>
                        <b>{{ strtoupper($pro->course) }} LAUTECH P.M.B. 4000</b>
                        <br/>
                        Ogbomoso.
                        <br/>
...
<p style="text-align:justify;font-size:14px; ">With reference to your application for admission to a higher degree course of this university
 in the Department of <b>@if($pro) {{ $pro->programme }} Faculty of {{ GetFaculty($pro->programme) }}</b>,@endif  it is my pleasure to inform you that the application is successful.
 Your registration will be for the degree of  @if($pro)  <b>{{ GetDegree($pro->degree)}} </b> @endif. Mode of your study is Full-Time.<br/>
