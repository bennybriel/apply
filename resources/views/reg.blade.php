...
.close:focus {
  ...
  cursor: pointer;
     ...
     <div class="container">
      ...
      <br/>
      <form class=""  id="" method="POST" action="{{ route('SubmitRegistration') }}">
                                                    {{ csrf_field() }}
          ...
          <div class="card mx-4">
            <div class="card-body p-4">
              ...
              <div class="input-group mb-3">
                   ...
                   <input class="form-control" type="text" name="surname" placeholder="Surname" value="{{ old('surname') }}" required>
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">
