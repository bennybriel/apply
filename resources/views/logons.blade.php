...
-->
      ...
      <form class=""  id="" method="POST" action="{{ route('AuthIn') }}">
                 {{ csrf_field() }}
            ...
            <div class="card p-4">
              ...
              <div class="card-body">
                ...
                <div class="input-group mb-3">
                  ...
                  <input class="form-control" type="text" name="email" value="{{ session('utme') }}" placeholder="" readonly>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-6 text-right">
                    <button class="btn btn-link px-0"  type="button"><a href="{{ route('forgotPassword') }}" style="color:#da251d">Forgot password?</a></button>
