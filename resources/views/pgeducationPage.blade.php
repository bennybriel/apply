...
<div class="card o-hidden border-0 shadow-lg my-5">
            ...
            <div class="card-body p-0">
                ...
                <form class=""  id="" enctype="multipart/form-data" method="POST" action="{{ route('PGEducationForms') }}">
                                        {{ csrf_field() }}
                                    ...
                                    <div class="text-center">
                                        ...
                                        @if($data)
                                                                ...
                                                                <?php
                                                                    ...
                                                                    @foreach($data as $data)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $data->endyear }}</td>  
                                                                            <td><a href="{{ route('DeleteEducation', $data->id) }}" class="btn btn-danger">Delete</a></td>
                                            ...
                                            @if($data)
                                                <div class="form-group">
                                                    <div class="col-sm-8 mb-3 mb-sm-0">
                                                    <a href="{{ route('pgqualificationPage') }}" class="btn btn-primary">
