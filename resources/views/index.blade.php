 ...
 <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                       <div class="p-5">
                          <h4><strong style="color:#c0a062">@if($result) {{ $result[0]->heading }}
                            @else
                              Admissions
                             @endif</strong></h4>
                            <p style="text-align:justify; "><strong>
                               ...
                               <p> {{ $result[0]->title }} </p>
                               <p> Have you signed up before?, Please <a href="{{ route('logon') }}">Login Now</a> </p> 
                              @else
                              Admissions
                             @endif
                           ...
                           @foreach($data as $data)
                                <div class="columns">
                                    <ul class="price">
                                        <li class="header">{{ $data->name}}</li>
                                        <li class="grey">&#8358;{{ number_format($data->amount,2) }} </li>
                                        <li style="color:red">Closes on {{ Carbon::parse($data->closedate)->format('d-m-Y') }}</li>
                                        
                                       <!-- <li style="color:#ffcc00"><p id="demo"></p></li> -->
                                        <li><a href="{{ $data->readmore }}" target="_blank">Read more</a></li>
                                        @if($data->status == false)
                                           <li class="grey"><a href="" class="btn btn-danger">Closed</a></li>
                                
                                        @else
                                        <li class="grey"><a href="{{ route('logon') }}" class="btn btn-success">Appy Now</a></li>
                                        @endif
                                      </ul>
                                </div>
                               @endforeach
                      ...
                      <div class="p-5">
                         ...
                         <div class="col-xl-3 col-md-12 mb-4"></div>
                              <h4><strong style="color:#c0a062">Create Account</strong></h4> <br/>  <br/>
                                <p style="text-align:justify; "><strong>
                                You can create account here so you that you will receive updates on our admissions. <a href="{{ route('reg') }}">Click here </a>
                                </strong>   </p>
                            </div>
                       </div>
                </div>
             ...
             <!-- Modal content-->
               <div class="modal-content">
                 ...
                 <div class="card-header">
                       <h4 class="m-0" style="color:brown;text-align:center;">LAUTECH 2021/2022 Post UTME Registration Closes On</h4>
                  </div>
                 
                <div class="modal-body">
                     
                <h5> <p id="demo" style="color:red;text-align:center;"></p> </h5>
                </div>
