...
<div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <form class=""  id="" enctype="multipart/form-data" method="POST" action="{{ route('UpdateLGAs') }}">
                                        {{ csrf_field() }}
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="form-group row">
                                       <div class="col-sm-8 mb-3 mb-sm-0">
                                               <select name="formnumber" id="formnumber" class="form-control form-control" required>
                                                      <option value="">Select Formnumber</option>
                                                        @foreach($frm as $frm)
                                                             <option value="{{ $frm->formnumber }}">{{ $frm->formnumber }}</option>
                                                         @endforeach
                                                   </select>
