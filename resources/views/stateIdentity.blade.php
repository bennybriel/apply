...
<div class="row">
  ...
  <div class="w3-container">
     ...
     @if($result)
	   <img class="nav-user-photo" src="{{ asset('public/Passports/'.$result[0]->photo)}}" alt="Member's Photo" width="80" height="80" />             		   </td>
               ...
               <thead>
                 ...
                 <tr>
                    ...
                    <td width="250" class="noBorder1">{{ $result[0]->stdname }}</td>
                  ...
                  <tr>
                    ...
                    <td class="noBorder1">{{ $result[0]->patname }}</td>
                 </tr>
                 <tr>
                   <td class="noBorder">
                   Address
                   </Address></td>
                    <td class="noBorder1">{{ $result[0]->address }}</td>
                 </tr>

                 <tr>
                   <td class="noBorder">State of Origin </td>
                    <td class="noBorder1">{{ $result[0]->state }}</td>
                 </tr>

                 <tr>
                   <td class="noBorder">Local Govt </td>
                    <td class="noBorder1"> {{  $result[0]->lga}} </td>
                 </tr>
                 ...
                 <tr>
                   <td class="noBorder">Date</td>
                    <td class="noBorder1"> {{ date("d-m-Y") }}</td>
                 </tr>
                 <hr/>
