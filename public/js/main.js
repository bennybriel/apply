...
(function($) {
	"use strict";
		...
		$('#clock-countdown').countdown('2021/11/09 00:00:00').on('update.countdown', function(event) {
			var $this = $(this).html(event.strftime(''
				+ '<div class="counter-container"><div class="counter-box first"><div class="number">%-D</div><span>Day%!d</span></div>'
				+ '<div class="counter-box"><div class="number">%H</div><span>Hrs</span></div>'
				+ '<div class="counter-box"><div class="number">%M</div><span>Mins</span></div>'
				+ '<div class="counter-box last"><div class="number">%S</div><span>Secs</span></div></div>'
			));
		});
